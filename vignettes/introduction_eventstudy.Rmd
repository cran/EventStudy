...
output:
  html_document:
    ...
    css: kable.css
vignette: >
  %\VignetteIndexEntry{Introduction in EventStudy R Package}
...
You get a **free** API key from our website [EventStudyTools](https://eventstudytools.com/api-key). In the first step we need to authenticate to the web API. There are three ways to handle this two parameters:
...
This API package is designed to perform all analyses we provide on our website. 
